...
Questo progetto è rilasciato sotto la PolyForm Noncommercial License — vedi il file [LICENSE](https://github.com/yumiaura/audio8bit/blob/main/LICENSE) per i dettagli.
