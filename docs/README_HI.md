...
- `-V, --voices` - `chords` (हार्मनी के साथ) या `lead` (एकल पंक्ति) या `band` (मल्टी-इंस्ट्रूमेंट: पल्स लीड + पल्स हार्मनी + ट्रायंगल बेस + नॉइज़ ड्रम) (डिफ़ॉल्ट: `chords`)
...
- **पॉलीफोनिक ट्रांसक्रिप्शन** (basic-pitch) कॉर्ड्स और बेस को बनाए रखता है, या उन्हें एकल लीड पंक्ति में सीमित कर देता है। `band` मोड उन्हें चिप चैनलों में बाँटता है (पल्स लीड, पल्स हार्मनी, ट्रायंगल बेस)। बेस, बेस स्टेम से और ड्रम, ड्रम स्टेम से आते हैं।
