...
- `-V, --voices` - `chords` (हार्मनी के साथ) या `lead` (एकल पंक्ति) (डिफ़ॉल्ट: `chords`)
...
- **पॉलीफोनिक ट्रांसक्रिप्शन** (basic-pitch) कॉर्ड्स और बेस को बनाए रखता है, या उन्हें एकल लीड पंक्ति में सीमित कर देता है।
