...
- `--key-snap` - band/nes: बेसुरे नोट्स को पहचानी गई की पर सेट करता है: `on`, `off` (डिफ़ॉल्ट: `on`)
- `--arrange` - band/nes: ट्रांसक्रिप्शन दोहराने की बजाय कॉर्ड प्रोग्रेशन संगत, रूट बेस और लूप ड्रम: `on`, `off` (डिफ़ॉल्ट: `on`)
- `--echo` - band/nes: मेलोडी पर टेम्पो-सिंक इको: `on`, `off` (डिफ़ॉल्ट: `on`)
- `--dither` - band/nes: बिट क्वांटाइज़ेशन से पहले TPDF डिदर: `on`, `off` (डिफ़ॉल्ट: `on`)
