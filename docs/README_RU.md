...
# Мультиинструментальный бэнд: pulse-лид + pulse-гармония + triangle-бас
...
- `-V, --voices` - `chords` (с гармонией) или `lead` (одна линия) или `band` (мультиинструмент: pulse-лид + pulse-гармония + triangle-бас) (по умолчанию: `chords`)
...
- **Полифоническая транскрипция** (basic-pitch) сохраняет аккорды и бас или сводит их к одной ведущей линии. Режим `band` распределяет их по чип-каналам (pulse-лид, pulse-гармония, triangle-бас).
